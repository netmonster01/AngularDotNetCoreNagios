...
import { Host, Service, HostCount, Count, ServiceCount } from '../../models';
...
export class HostsComponent implements OnInit {
  ...
  //  this.nagios.$ServiceCounts.subscribe((counts: any) => this.serviceCounts = counts);
  //}

  //getHostCounts(): any {
  //  this.nagios.$HostCounts.subscribe((counts: any) => this.hostCounts = counts);
  //}
